...
class RunConfig:
    ...
    answering_model: str = "deepseek-chat" #or "gpt-4o-2024-08-06"
    config_suffix: str = ""
...
deepseek_config = RunConfig(
    ...
    llm_reranking=True,
    parallel_requests=20,
    submission_name="DeepSeek v.1",
    pipeline_details="Custom pdf parsing + vDB + Router + Parent Document Retrieval + reranking; llm = deepseek-chat",
    answering_model="deepseek-chat",  # 使用 DeepSeek 模型
...
configs = {"base": base_config,
           ...
           "deepseek": deepseek_config}  # DeepSeek API configuration
